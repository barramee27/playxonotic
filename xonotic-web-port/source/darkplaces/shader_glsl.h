...
"#endif\n",
"#if defined(MODE_LIGHTGRID) && !defined(GLES)\n",
"uniform sampler3D Texture_LightGrid;\n",
"uniform mat3 LightGridNormalMatrix;\n",
"#endif\n",
"#if defined(USEBOUNCEGRID) && !defined(GLES)\n",
...
"#ifdef MODE_LIGHTGRID\n",
"#ifndef GLES\n",
"	// clamp the LightGrid TC Z coordinate to the first of the 3 layers\n",
...
"#endif\n",
"#else\n",
"	// GLES/WebGL fallback: lightgrid sampling requires sampler3D (unavailable in GLSL ES 100).\n",
"	// Approximate with ambient + diffuse to roughly match native brightness.\n",
"	color.rgb = diffusetex * (Color_Ambient + Color_Diffuse) * 1.25;\n",
"#ifdef USESPECULAR\n",
"	color.rgb += glosstex.rgb * Color_Specular * 0.3;\n",
"#endif\n",
"#endif\n",
"#endif\n",
"\n",
